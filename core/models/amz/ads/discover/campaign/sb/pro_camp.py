...
from core.manager import AmzSbDiscProCampManager


class SBDiscProCamp(BaseModel):
    campaign = models.ForeignKey(
        AmzSbAdsCamp, null=True, blank=True, on_delete=models.DO_NOTHING)
    ...
    manager = AmzSbDiscProCampManager()
