...
from core.manager import AmzSpDiscProCampManager


class SPDiscProCamp(BaseModel):
    campaign = models.ForeignKey(
        AmzSpAdsCamp, null=True, blank=True, on_delete=models.DO_NOTHING)
    ...
    manager = AmzSpDiscProCampManager()
