...
from core.manager import SpDiscFetchProCampManager


class SpDiscFetchProCamp(BaseModel):
    campaign = models.ForeignKey(
        AmzSpAdsCamp, null=True, on_delete=models.DO_NOTHING)
    ...
    manager = SpDiscFetchProCampManager()
