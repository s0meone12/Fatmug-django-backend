import pandas as pd
from core.models import SpProCampaignAction
from ........base import CheckQSMeta
from .main import SpProCampActionValueManager


class SpProCampActionSubManagerSpProActionValue(metaclass=CheckQSMeta):
    def __init__(self, manager: SpProCampActionValueManager):
        self.manager = manager
        self.model = SpProCampaignAction
