import pandas as pd
from core.models import SBDiscKeyCamp
from ........base import CheckQSMeta
from .main import SbKeyCampActionManager


class SbKeyCampSubManagerSbKeyAction(metaclass=CheckQSMeta):
    def __init__(self, manager: SbKeyCampActionManager):
        self.manager = manager
        self.model = SBDiscKeyCamp
