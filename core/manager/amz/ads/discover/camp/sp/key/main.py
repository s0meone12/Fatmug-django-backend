...
class AmzSpDiscKeyCampManager(BaseManager):
    ...
    def aso(self):
        if not self.__aso:
            from .aso import AdsAssociatorSubManagerAmzSpDiscKeyCamp
            self.__aso = AdsAssociatorSubManagerAmzSpDiscKeyCamp(self)
        return self.__aso

    @property
    def amz_sku(self):
        if not self.__amz_sku:
            from .amz_sku import AmzSkuSubManagerSpDiscKeyCamp
            self.__amz_sku = AmzSkuSubManagerSpDiscKeyCamp(self)
