...
class AmzSbDiscKeyCampManager(BaseManager):
    ...
    def aso(self):
        if not self.__aso:
            from .aso import AdsAssociatorSubManagerAmzSbDiscKeyCamp
            self.__aso = AdsAssociatorSubManagerAmzSbDiscKeyCamp(self)
        return self.__aso

    @property
    def amz_sku(self):
        if not self.__amz_sku:
            from .amz_sku import AmzSkuSubManagerSbDiscKeyCamp
            self.__amz_sku = AmzSkuSubManagerSbDiscKeyCamp(self)
